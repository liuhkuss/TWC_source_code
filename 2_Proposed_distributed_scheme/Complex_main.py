...
#C_max = PS.C_max
#C_max = str(C_max)
#for index,network in enumerate(network_set):
#    pathname = './saved/' + C_max + '/' + str(index)
#    evaluate_model = tf.keras.models.load_model(pathname, compile=False)
#    network.evaluate_model = evaluate_model
